...
Do you have access to, and the ability to benefit from, your own data?
...
Once you have keys, communication, storage and a well-known system for dealing with projects/inputs you will be more powerful than a million men.  Having the direction, insight and determination to accomplish your goals is the key to effortless creation.


### Next steps.

- [Tao Te Ching](https://en.wikipedia.org/wiki/Tao_Te_Ching)
- [The Art of Allowing](https://www.hayhouse.com/the-art-of-allowing-audio-download) by Jerry and Ester Hicks
...
3. Check out more of my ramblings (the contents of this repo) > [docs.koad.sh](https://docs.koad.sh)
